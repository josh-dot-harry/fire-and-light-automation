...
namespace FaL_PageObjects.PathHelpers;
public static class XPathHelper
{
    public static string EscapeXpath(string value)
    {
        if (value.Contains("'") || value.Contains("\"")) return XPathLiteral(value);

        return $"'{value}'";
    }
    /// <summary>
    /// Solution for gnarley way xpath handles quotes. As found on <see href="https://stackoverflow.com/questions/1341847/apostrophe-in-xpath-query"/>
